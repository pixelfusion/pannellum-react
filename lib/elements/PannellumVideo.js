  ...
  function PannellumVideo(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderVideo", function (state) {
      ...
      if (state === "update") {
        ...
        _this.video = (0, _video["default"])(_this.videoNode, _extends({
          loop: _this.props.loop,
          autoplay: _this.props.autoplay,
          controls: _this.props.controls,
          muted: _this.props.muted,
          plugins: {
            pannellum: _extends({}, _this.props, {
              hotSpots: hotspotArray
            })
          }
        }, _this.props.videoJsConfig || {}));
...
PannellumVideo.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  // Video JS options
  videoJsConfig: _propTypes["default"].object,
  ...
  autoRotateInactivityDelay: _propTypes["default"].number,
  autoRotateStopDelay: _propTypes["default"].any,
  type: _propTypes["default"].oneOf(['cubemap', 'multires', 'equirectangular']),
  northOffset: _propTypes["default"].number,
  ...
  avoidShowingBackground: _propTypes["default"].bool,
  animationTimingFunction: _propTypes["default"].func,
  draggable: _propTypes["default"].bool,
  disableKeyboardCtrl: _propTypes["default"].bool,
  crossOrigin: _propTypes["default"].oneOf(['anonymous', 'use-credentials']),
  touchPanSpeedCoeffFactor: _propTypes["default"].number
} : {};
